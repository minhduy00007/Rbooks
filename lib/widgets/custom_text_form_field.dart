...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle?.merge(TextStyle(color: Colors.black)) ?? CustomTextStyles.bodySmallOnPrimaryContainer.merge(TextStyle(color: Colors.black)),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumPoppinsLight13,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillOrangeTL10 => OutlineInputBorder(
